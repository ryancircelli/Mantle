 ...
 * <p>
 * This wraps vanilla's layer rather than {@link RegisterGuiLayersEvent#replaceLayer replacing} it, which keeps the
 * vanilla renderer reachable for {@link HeartRenderer#DISABLE} - a config value that can change without a restart.
 */
...
public class ExtraHeartRenderHandler implements LayeredDraw.Layer {
  ...
  private boolean renderHealthbar(GuiGraphics graphics) {
    ...
    // each vanilla layer sets up its own blending
    ...
    // tell the layers below us how much room we took
