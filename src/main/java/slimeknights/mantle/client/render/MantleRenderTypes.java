...
public final class MantleRenderTypes {
  ...
  /**
   * Vertex format used for the structure renderer. {@link DefaultVertexFormat#NEW_ENTITY} matches the required
   * elements exactly, so it is aliased rather than rebuilt.
   */
