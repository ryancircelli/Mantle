...
public class SimpleBlockModel implements IUnbakedGeometry<SimpleBlockModel> {
  ...
  public void resolveParents(Function<ResourceLocation,UnbakedModel> modelGetter, IGeometryBakingContext owner) {
    ...
    parent = blockModel;
    // the rest of the chain is vanilla's own job: BlockModel#resolveParents walks it, detects loops, falls back to
    // the missing model, and resolves any custom geometry or item overrides a parent declares
