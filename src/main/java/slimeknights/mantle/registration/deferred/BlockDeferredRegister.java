...
public class BlockDeferredRegister extends DeferredRegisterWrapper<Block> {
  ...
  public WoodBlockObject registerWood(String name, Function<WoodVariant,BlockBehaviour.Properties> behaviorCreator, boolean flammable) {
    ...
    ItemObject<PressurePlateBlock> pressurePlate = register(name + "_pressure_plate", // pressure plate sensitivity moved onto BlockSetType in 1.21; every wood-shaped set type carries EVERYTHING,
      // which is what this used to pass explicitly
