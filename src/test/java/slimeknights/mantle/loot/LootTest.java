 ...
 * {@link com.mojang.serialization.MapCodec}, and {@link LootTableInjection}'s List rewrite - the class M2 flagged as
 * needing a real rebuild once {@code LootPool#entries} stopped being an array.
 */
class LootTest extends LoadableTest {
  ...
  void tagPreferenceEntry_roundTripsAsJson() {
    ...
    // that is LootPoolEntries.CODEC's job - and weight/quality are absent at their defaults per M8's
    // optionalFieldOf surprise (it does not write the default back out).
