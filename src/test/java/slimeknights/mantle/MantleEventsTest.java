 ...
 * <p>
 * The compound those entries live in is {@code minecraft:custom_data} in 1.21 rather than the stack's own tag (M4 §6),
 * so the assertions read it through {@link BaseMcTest}'s custom data helpers. The layout inside that compound - the
