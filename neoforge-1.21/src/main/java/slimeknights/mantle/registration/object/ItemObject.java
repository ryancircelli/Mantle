...
public class ItemObject<I extends ItemLike> implements Supplier<I>, ItemLike, IdAwareObject {
  ...
  /**
   * Creates a new item object using the given deferred holder. This variant can resolve its name before the entry resolves
   * @param object  Object base
   */
  public <T extends I> ItemObject(DeferredHolder<? super T,T> object) {
    this.entry = object;
