  ...
  public void load() {
    ...
    if (!StringUtils.isEmpty(recipe) && ResourceLocation.tryParse(recipe) != null) {
      ...
      if (recipe instanceof CraftingRecipe) {
        ...
        // 1.21: NeoForge's IShapedRecipe is gone; vanilla's ShapedRecipe (which Mantle's own
        // ShapedFallbackRecipe/ShapedRetexturedRecipe both extend) exposes the same width/height directly
