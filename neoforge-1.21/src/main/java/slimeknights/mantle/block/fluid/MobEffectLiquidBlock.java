...
public class MobEffectLiquidBlock extends LiquidBlock {
  ...
  public void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
    if (entity.getFluidTypeHeight(fluid.getFluidType()) > 0 && entity instanceof LivingEntity living) {
      // 1.20's setCurativeItems(empty list) stopped milk and friends from clearing the effect; NeoForge dropped
      // curative items entirely in 1.21, so the effect is simply added as-is
