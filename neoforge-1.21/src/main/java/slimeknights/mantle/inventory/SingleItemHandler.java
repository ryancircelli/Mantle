...
public abstract class SingleItemHandler<T extends MantleBlockEntity> implements IItemHandlerModifiable {
   ...
   * @param registries  Registry access, needed to serialize the stack's data components
   ...
   * @param nbt         NBT
   * @param registries  Registry access, needed to deserialize the stack's data components
   */
