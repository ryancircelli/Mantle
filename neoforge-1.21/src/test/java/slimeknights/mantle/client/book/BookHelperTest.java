 ...
 * older Mantle.
 * <p>
 * That compound lives inside {@code minecraft:custom_data} in 1.21 rather than on the stack itself (M4 &sect;6), so the
 * assertions reach it through {@link BaseMcTest}'s custom data helpers. The nesting they check is unchanged.
 */
